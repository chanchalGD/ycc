package com.ycc.security.component;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.ycc.security.model.JwtAuthenticatioToken;
import com.ycc.security.utils.HttpUtils;
...
public class JwtLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public String getBody(HttpServletRequest request) {
        ...
        try {
            ...
            closeStreamAndReader(inputStream);
            closeStreamAndReader(reader);
        }
        return sb.toString();
    }
     ...
     * @param closeable
     * **/
    private void closeStreamAndReader(Closeable closeable){
        if (closeable != null) {
            try {
                closeable.close();
            } catch (IOException e) {
